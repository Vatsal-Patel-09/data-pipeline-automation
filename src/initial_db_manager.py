import json
import psycopg2
import logging #just keeping track
...
class DatabaseManager: #class defination to manage database operations
    def __init__(self, config_path: str = None): #init is a special method "constructor" to initialize the class 
        """Initialize database manager with connection details"""
        if config_path:
            load_dotenv(config_path)
        #reading database details from environment variables
